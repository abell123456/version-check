...
console.log(chalk.blue('本地: %s' + chalk.blue(' 分支版本号为: ') + chalk.bold.red('%s')), chalk.green(curBranch), curVersion);
console.log(chalk.blue('远程: %s' + chalk.blue(' 分支版本号为: ') + chalk.bold.red('%s')), chalk.green('master'), masterVersion);
